...
float TinhTongBien(float a[][MAX], int dong, int cot) {
  ...
  // Tính tổng của cột đầu v cột cuối (bỏ đi 2 ô đầu và cuối).
...
// Bài 33 9: Đếm số lượng số hoàn thiện trên 1 hàng
// Bài 34 0: Đếm số lượng số âm trên 1 cột.
// Bài 34 1: Đếm số lượng số dương trên biên ma trận

// = > Hoàn toàn tương tự các bài trước đó.

// Bài 342 (* ): Đếm số lượng phần tử cực đại trong matrận cc số thực. Một phần 
// tử được gọi là cực đại khi nó lớn hơn các phần tử xung quanh.

// Bài 343 (* ): Đếm số lượng phần tử cực trị trong ma rận các số thực. Một phần 
...
// Lưu  ý: Nếu có k phn tử (k >= 1) trong ma trận bằng nhau thì ta chỉ tính 1
...
// = > có 3 phần tử phân b iệt là: 1, 2, 0
...
// Bài 346 (* ): Đếm số lượng giá trị hoàng hậ trên ma trận. Một phần tử được gọi là hoàng hậu
// khi nó lớn nhất trên dòng, trên cột và hai đường chéo đi qua nó.

// = > GỢI  Ý:
// vd: Ma trận đang xét là 4 x 5
// a[i][j] đang xét  là: a[1][2]
// + Xét dòng đang chứ a nó: Cố định dòng đang đứng và cột chạy từ 0 cho tới cột - 1
// + Xét cột đang chứ a nó: Cố định cột đang đứng và dòng chạy từ 0 cho tới dòng - 1
// + Xét chéo đi từ trên trái xuống  dưới phải: a[0][1], a[1][2], a[2][3], a[3][4]
// = > hình thành 2 đường đi lên và i xuống. đi lên thì cột và dòng cùng giảm 1, đi xuống thì cột và
// dòng cùng tăng 1.
...
// Bài 368: Tìm giá trị lớn thứ nhì tron ma trận. Giả sử ma trận có nhiều hơn hai giá trị.

// = > CẢI TIẾN ĐỀ BÀI: Nhậ vào số k (số lượng phần tử phân biệt >= k >= 1) tìm ra phần tử
